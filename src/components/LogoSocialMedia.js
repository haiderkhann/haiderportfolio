...
export default function LogoSocialMedia() {
  return (
    <>
      <p className={scss.logo}>HaiderAbbas</p>
      <div className={scss.social_media}>
        <a
          href="https://github.com/haiderkhann/haiderkhann"
          target="_blank"
          rel="noreferrer"
        ...
        <a
          href="https://www.linkedin.com/in/haiderkhann?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BF9UD5V7pQ46NDiZY%2FOHxTw%3D%3D"
          target="_blank"
          rel="noreferrer"
        ...
        <a
          href="https://x.com/haider_abbas125?t=yFJohW_xeB0rEaC2jckETg&s=09"
          target="_blank"
          rel="noreferrer"
